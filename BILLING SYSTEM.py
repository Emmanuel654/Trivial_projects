...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("Designed by Emmanuel Frederique")
        ...
        lbl_color = 'white'
        #Title of App
        title = Label(self.root,text = "WELCOME TO RIQUE'S SUPERMARKET",bd = 12,relief = GROOVE,fg = fg_color,bg = bg_color,font=("times new roman",30,"bold"),pady = 3).pack(fill = X)
        ...
        #====================Bill Search Button===============#
        bill_btn = Button(F1,text = "Search",bd = 7,relief = GROOVE,font = ("times new roman",12,"bold"),bg = bg_color,fg = fg_color)
        bill_btn.grid(row = 0,column = 8,ipady = 5,padx = 60,ipadx = 19,pady = 5)

        bill_btn = Button(F1,text = "Save",bd = 7,relief = GROOVE,font = ("times new roman",12,"bold"),bg = bg_color,fg = fg_color)
        bill_btn.grid(row = 0,column = 9,ipady = 7,padx = 85,ipadx = 0,pady = 9)
        ...
        #===========
        bill_title = Label(F3,text = "RECEIPT",font = ("Lucida",13,"bold"),bd= 7,relief = GROOVE)
        ...
        total_btn.grid(row = 0,column = 4,ipadx = 20,padx = 20)
        ...
        genbill_btn.grid(row = 0,column = 5,ipadx = 10)

        #====================
        clear_btn = Button(F4,text = "Clear",bg = bg_color,fg = fg_color,font=("lucida",12,"bold"),bd = 7,relief = GROOVE,command = self.clear)
        clear_btn.grid(row = 0,column = 6,ipadx = 10,padx = 10)

        #======================
        exit_btn = Button(F4,text = "EXIT SYSTEM",bg = "RED",fg = fg_color,font=("lucida",12,"bold"),bd = 7,relief = GROOVE,command = "exit")
        exit_btn.grid(row = 1,column = 6,ipady = 10,padx = 20,ipadx = 45,pady = 5)
        
        #====================
        save_btn = Button(F4,text = "Save",bg = "green",fg = fg_color,font=("lucida",12,"bold"),bd = 7,relief = GROOVE,command = saveFile)
        save_btn.grid(row = 0,column = 7,ipadx = 0)
...
#Function to get total prices
    def total(self):
        ...
        self.total_cosmetics.set("KSH. "+str(self.total_cosmetics_prices))
        self.tax_cos.set("KSH. "+str(round(self.total_cosmetics_prices*0.05)))
        ...
        self.total_grocery.set("KSH. "+str(self.total_grocery_prices))
        self.tax_groc.set("KSH. "+str(round(self.total_grocery_prices*0.05)))
        #======================Total Other Prices
        ...
        self.total_other.set("KSH. "+str(self.total_other_prices))
        self.tax_other.set("KSH. "+str(round(self.total_other_prices*0.05)))


#Function For Text Area
    def welcome_soft(self):
        self.txt.delete('1.0',END)
        self.txt.insert(END,"   Welcome To Frederick's Retail\n")
...
def saveFile(self):
    ...
    if f!= None:
        welcome_soft =self.txt.get('1.0',END)
    try:
        f.write(welcome_soft)
        self.txt.delete(1.0,END)
        self.txt.insert(INSERT,"Spreadsheet Saved Successfully !")
    except:
