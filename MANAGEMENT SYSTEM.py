...
def exit():
  exit=tkinter.messagebox.askyesno("BY FREDERICK","Do you want to exit the system")
  if exit>0:
    root.destroy()
    return
...
payslip=Label(f2,textvariable=DateOfOrder,font=('Lucida',21,'bold'),fg="red",bg="powder blue").grid(row=0,column=0)
txtpayslip=Text(f2,height=22,width=34,bd=16,font=("Lucida",13,"bold"),fg="black",bg="white")
